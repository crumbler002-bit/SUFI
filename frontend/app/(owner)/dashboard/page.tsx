...
export default function DashboardPage() {
  ...
  const [overbook,   setOverbook]   = useState(autoStatus?.auto_overbooking ?? true);
  const [reschedule, setReschedule] = useState(autoStatus?.auto_reschedule  ?? true);
  const [autoCancel, setAutoCancel] = useState(autoStatus?.auto_cancel      ?? false);

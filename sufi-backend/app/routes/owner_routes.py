    ...
    return [
        {
            ...
            "restaurant_name": reservation.restaurant.name if reservation.restaurant else None,
            "customer_name": reservation.user.name if reservation.user else "Guest",
            "party_size": reservation.guests,
            "time": reservation.reservation_time.isoformat() if reservation.reservation_time else None,
            "status": reservation.status,
            "table_id": reservation.table_id,
            "is_upcoming": bool(reservation.reservation_time and reservation.reservation_time >= now),
        }
